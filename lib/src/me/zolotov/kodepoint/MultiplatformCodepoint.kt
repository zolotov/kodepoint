...
internal expect fun codePointsToStringPlatformSpecific(vararg codepoints: Int): String
...
internal expect fun codepointOfPlatformSpecific(highSurrogate: Char, lowSurrogate: Char): Codepoint
...
internal expect fun highSurrogatePlatformSpecific(codepoint: Int): Char

internal fun highSurrogateMultiplatform(codepoint: Int): Char {
  return ((codepoint ushr 10) + HIGH_SURROGATE_ENCODE_OFFSET).toChar()
}

internal expect fun lowSurrogatePlatformSpecific(codepoint: Int): Char
